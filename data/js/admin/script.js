...
var Login = function (p) {
    ...
    var loaded = function () {
        ...
        $("#fWebRegister").validate({
            ...
            messages: {
                webaddress: {
                    required: tran("Mời bạn nhập địa chỉ web|Please enter your web address name|Пожалуйста, введите ваш пароль|请输入您的密码|あなたのパスワードを入力してください。")
                }
            },
            submitHandler: function () {
                ...
                web.iReq({ action: 'iWebRegister', webaddress: $('#fWebRegister #iWebaddress').val() }, function (data) {
                    $('.lError').html('Đăng ký thành công, hãy liên hệ hỗ trợ để tiến hành cài đặt thêm').addClass('lForm');
